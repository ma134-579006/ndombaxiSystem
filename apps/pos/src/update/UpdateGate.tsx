 ...
 *      vendas por enviar. NÃO tranca nada: mostra uma faixa a explicar, e a
 *      Caixa continua a vender. É a regra que evita deixar uma loja sem sistema
 *      e com dias de trabalho por salvar.
