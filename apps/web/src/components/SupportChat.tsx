...
export function SupportChat() {
  ...
  return (
    <>
      {/* Balão flutuante — só quando FECHADO (evita sobrepor-se ao painel/X) */}
      {!open ? (
        <button className="sc-fab" onClick={() => setOpen(true)} aria-label="Falar connosco">
      ...
      {open ? (
        <div className="sc-panel">
          <div className="sc-head">
            ...
            <button className="sc-reset" onClick={() => setOpen(false)} title="Fechar" aria-label="Fechar">
