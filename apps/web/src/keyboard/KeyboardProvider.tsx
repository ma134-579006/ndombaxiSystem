...
const LS_KEY = 'ndombaxi.web.virtualKeyboard';

/**
 * Monta UM teclado no ecrã, partilhado por todos os campos (KeyboardInput).
 * Para os "PCs apenas digitais" (terminais táteis de shopping). Encerra com um
 * pequeno atraso ao perder o foco — para trocar de campo sem o teclado piscar.
 */
...
/** Hook opcional: devolve null se não houver provider (degrada sem crashar). */
